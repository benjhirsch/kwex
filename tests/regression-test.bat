...
if %NO_SPICE% == 1 (
    set template_name=regression_test_no_spice.vm
    set success_lblx=success\regression_test_no_spice_success.lblx
    set success_json=success\vals_regression_test_no_spice_success.json
    set success_log=success\regression_test_no_spice_success.log
    set success_nts=success\regression_test_no_spice_success_nts.log
) else (
    set template_name=regression_test.vm
    set success_lblx=success\regression_test_success.lblx
    set success_json=success\vals_regression_test_success.json
...
fc output\regression_test.lblx %success_lblx% >nul
if errorlevel 1 (
    echo lblx bad
) else (
    echo lblx good
...
fc output\vals_regression_test.json %success_json% >nul
if errorlevel 1 (
    echo json bad
) else (
    echo json good
